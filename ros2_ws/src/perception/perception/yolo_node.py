...
[ ] add remaining model paths (mallet, bottle) once trained on roboflow
[ ] test on ZED cam input
[ ] tune confidence threshold per-class if needed
[ ] fuse with aruco_node for combined obstacle avoidance
...
MODELS
------
Models live in perception/models/<class_name>/best.onnx
Export from Roboflow as ONNX (not .pt) for deployment on Jetson without full PyTorch.

Current models:
    models/hammer/best.onnx     — rock pick hammer  [exists]
    models/mallet/best.onnx     — orange rubber mallet  [TODO: train + export]
    models/bottle/best.onnx     — 1L water bottle  [TODO: train + export]
...
terminal 3: visualization
    ...
    # select '/perception/yolo_debug' in the dropdown
